...
vc_add_shortcode_param('product' , 'product_settings_field');
/* All products dropdown */
...
vc_add_shortcode_param('products' , 'products_settings_field', plugins_url("assets/js/functions.js", __FILE__));
...
vc_add_shortcode_param('product_category' , 'product_category_settings_field');
/* Portfolio categories new parameter */
...
vc_add_shortcode_param('product_categories' , 'product_categories_settings_field', plugins_url("assets/js/functions.js", __FILE__));
...
vc_add_shortcode_param('product_attribute' , 'product_attribute_settings_field');
/* VC order tracking */
vc_map( array(
